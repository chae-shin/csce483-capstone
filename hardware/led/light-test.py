...
# Completion Script - Turns on all LEDs with random colors
def completion(strip):
    for i in range(strip.numPixels()):
        strip.setPixelColor(i, Color(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))) # Random Colors
        strip.show()
        time.sleep(0.01)
